...
function getListItem({ id, title, completed }) {
  ...
  // создание переменных один раз вне обработчика событий клика кнопки удаления
  ...
  $delete.addEventListener("click", () => {
    ...
    function closePopup() {
      ...
      $popupBtnNo.removeEventListener("click", cancelDelete);
      $popupBtnYes.removeEventListener("click", confirmDelete);
    }
    ...
    $popupBtnNo.addEventListener("click", cancelDelete);
    $popupBtnYes.addEventListener("click", confirmDelete);
  });
...
// змінити статус елемента task (додавання класу)
